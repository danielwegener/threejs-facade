...
import org.denigma.threejs.core.{BufferGeometry, Geometry, Object3D}
import org.denigma.threejs.extras.animation.AnimationData
import org.denigma.threejs.extras.core.Font
import org.denigma.threejs.materials.Material
import org.denigma.threejs.textures.{CompressedTexture, Texture}
import org.scalajs.dom.ProgressEvent
import org.scalajs.dom.raw.{HTMLElement, HTMLImageElement, XMLHttpRequest}
...
class FontLoader(manager: LoadingManager = js.native) extends js.Object with LoaderBase[Font]
...
class ImageLoader(manager: LoadingManager = js.native) extends js.Object with LoaderBase[HTMLImageElement] {
...
@js.native
trait LoaderBase[T] extends js.Any {
...
class TextureLoader(manager: LoadingManager = js.native) extends LoaderBase[Texture] {
  ...
  override def load(url: String, onLoad: js.Function1[Texture, _], onProgress: js.Function1[ProgressEvent, _],
    onError: js.Function1[js.Any, _] = js.native): Unit = js.native
  override def setCrossOrigin(crossOrigin: String): Unit = js.native
}
