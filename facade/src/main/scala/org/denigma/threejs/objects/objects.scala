...
class Mesh extends Object3D {
  ...
  var drawMode: TriangleDrawMode = js.native
...
/**
  ...
  * For example, if using the WebGLRenderer, the particles are displayed using GL_POINTS.
  * @see [[http://threejs.org/docs/#Reference/Objects/Points]]
  */
@js.native
@JSName("THREE.Points")
class Points extends Object3D {
  def this(geometry: Geometry, material: Material = js.native) = this()
