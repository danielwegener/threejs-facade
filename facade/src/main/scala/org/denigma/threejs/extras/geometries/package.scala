...
class TubeGeometry(path: Path, segments: Double = js.native, radius: Double = js.native, radiusSegments: Double = js.native, closed: Boolean = js.native) extends Geometry {
  /** An object with all of the parameters that were used to generate the geometry. */
  var parameters: js.Any = js.native
