...
import org.denigma.threejs.math.{Color, Vector2, Vector3}
import org.denigma.threejs.textures.{CubeTexture, Texture}
...
@js.native
trait MaterialParameters extends js.Any {
...
@js.native
trait MeshStandardMaterialParameters extends js.Any {
...
@js.native
@JSName("THREE.MeshStandardMaterial")
...
class PointsMaterial extends Material {
  ...
  var sizeAttenuation: Boolean = js.native
  /**
    * Define how the vertices gets colored. Possible values are [[THREE.NoColors]],
    * [[THREE.FaceColors]] and [[THREE.VertexColors]]. Default is [[THREE.NoColors]].
    *
    * This setting might not have any effect when used with certain renderers.
    * For example, it is ignored with the Canvas renderer, but does work with the WebGL renderer.
    */
...
@js.native
trait ShaderMaterialExtensions extends js.Any {
...
class ShaderMaterial extends Material {
  ...
  var extensions: ShaderMaterialExtensions = js.native
