...
import org.denigma.threejs.math.{Color, Vector2, Vector3, Vector4}
...
@js.native
@JSName("THREE.WebGLProperties")
trait WebGLProperties extends js.Any {
  def get(`object`: Object3D): js.Any = js.native
  def delete(`object`: Object3D): Unit = js.native
