...
trait EventDispatcher extends js.Any {
  /**
   ...
   * @param listener The function that gets called when the event is fired.
   */
  def hasEventListener(`type`: String, listener: js.Function1[js.Any, _]): Boolean = js.native
...
class Object3D extends js.Object with EventDispatcher {
  ...
  @deprecated(message = ".translate() has been removed. Use .translateOnAxis( axis, distance ) instead.", since = "r74")
  ...
  @deprecated(message = ".getChildByName() has been renamed to .getObjectByName()", since = "r74")
...
class InterleavedBufferAttribute[T, REPR <: TypedArray[T, REPR]]
(interleavedBuffer: InterleavedBuffer[T, REPR], itemSize: Double, offset: Double) extends BufferAttribute[T, REPR] {
